...
public class BinarySearchTree<E extends Comparable<E>> extends BinaryTree<E> implements IBSearchTree<E> {
    ...
    @Override
    public void addNode(E theItem){root = addNode(root, theItem);}
    ...
    @Override
    public boolean nodeContains(E desiredItem){return findItem(desiredItem)!= null;}

    @Override
    public E findItem(E desiredItem){return findItem(root, desiredItem);}
